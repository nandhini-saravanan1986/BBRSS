...
import com.bornfire.xbrl.entities.BRSS.BRS5_ENTITY;
...
public class BRS5_ReportService {
	
	private static final Logger logger = LoggerFactory.getLogger(BRS5_ReportService.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS5_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS5_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS5_view(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BRS5_ENTITY> T1rep = new ArrayList<BRS5_ENTITY>();
			// Query<Object[]> qr;

			List<BRS5_ENTITY> T1Master = new ArrayList<BRS5_ENTITY>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BRS5_ENTITY a where a.report_date = ?1 ", BRS5_ENTITY.class)
	...
	public ModelAndView getBRS5currentDtl(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"BRS5::reportcontent");
	...
	public File getFileBRS5(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS5.jrxml");
					}
