...
import com.bornfire.xbrl.entities.BRSS.BRS35_ENTITY;
...
public class BRS35_SERVICE {
	
	private static final Logger logger = LoggerFactory.getLogger(BRS35_SERVICE.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS35_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS35_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS35_View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BRS35_ENTITY> T1rep = new ArrayList<BRS35_ENTITY>();
			// Query<Object[]> qr;

			List<BRS35_ENTITY> T1Master = new ArrayList<BRS35_ENTITY>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BRS35_ENTITY a where a.report_date = ?1 ", BRS35_ENTITY.class)
	...
	public ModelAndView getBRS35Details(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"BRS35::reportcontent");
	...
	public File getFileBRS35(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS35.jrxml");
					}
