...
import com.bornfire.xbrl.entities.BRSS.BRS33_ENTITY;
import com.bornfire.xbrl.entities.BRSS.BRS33_T2_ENTITY;
import com.bornfire.xbrl.entities.BRSS.BRS36_ENTITY;
...
public class BRS33_SERVICE {
	private static final Logger logger = LoggerFactory.getLogger(BRS33_SERVICE.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS33_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS33_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS33_View(String reportId, String fromdate, String todate, String currency, String dtltype,
				...
				List<BRS33_ENTITY> T1rep = new ArrayList<BRS33_ENTITY>();
				
				List<BRS33_ENTITY> T1Master = new ArrayList<BRS33_ENTITY>();

				// Query<Object[]> qr;

	 

				List<BRS33_T2_ENTITY> T2Master = new ArrayList<BRS33_T2_ENTITY>();
				...
				//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
					...
					T1Master = hs.createQuery("from  BRS33_ENTITY a where a.report_date = ?1 ", BRS33_ENTITY .class)

							.setParameter(1, df.parse(todate)).getResultList();
					
					T2Master = hs.createQuery("from  BRS33_T2_ENTITY a where a.report_date = ?1 ", BRS33_T2_ENTITY .class)
	...
	public ModelAndView getBRS33Details(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"BRS33::reportcontent");
	...
	public File getFileBRS33(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS33.jrxml");
					} else {
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS33.jrxml");
					}
