...
import com.bornfire.xbrl.entities.BRSS.BRS17_ENTITY;
import com.bornfire.xbrl.entities.BRSS.BRS19_ENTITY;
...
public class BRS19_REPORTSERVICE {
	private static final Logger logger = LoggerFactory.getLogger(BRS19_REPORTSERVICE.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS19_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS19_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS19View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BRS19_ENTITY> T1rep = new ArrayList<BRS19_ENTITY>();
			// Query<Object[]> qr;

			List<BRS19_ENTITY> T1Master = new ArrayList<BRS19_ENTITY>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BRS19_ENTITY a where a.report_date = ?1 ", BRS19_ENTITY .class)
	...
	public ModelAndView getBRS19currentDtl(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"BRS19::reportcontent");
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS19.jrxml");
					}
