...
import com.bornfire.xbrl.entities.BRSS.BRS1_ENTITY;
...
public class BRS1_ReportService {
	
	private static final Logger logger = LoggerFactory.getLogger(BRS1_ReportService.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS1_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS1_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS1_view(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BRS1_ENTITY> T1rep = new ArrayList<BRS1_ENTITY>();
			// Query<Object[]> qr;

			List<BRS1_ENTITY> T1Master = new ArrayList<BRS1_ENTITY>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BRS1_ENTITY a where a.report_date =?1 ", BRS1_ENTITY.class)
	...
	public ModelAndView getBRS1currentDtl(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"BRS1::reportcontent");
	...
	public File getFileBRS1(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS1.jrxml");
					}
