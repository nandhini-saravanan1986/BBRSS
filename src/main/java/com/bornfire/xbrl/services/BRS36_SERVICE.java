...
public class BRS36_SERVICE {
	private static final Logger logger = LoggerFactory.getLogger(BRS36_SERVICE.class);
	...
	public String preCheckBRS36(String reportid, String fromdate, String todate) {
		...
		try {
			...
			Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS36_ENTITY a where a.report_date=?1")
					.setParameter(1, dt9).getSingleResult();

			if (dtlcnt > 0) {
				logger.info("Getting No of records in Mod table :" + reportid);
				Long modcnt = (Long) hs.createQuery("select count(*) from BRS36_ENTITY a").getSingleResult();
				if (modcnt > 0) {
					msg = "success";
				}
			} else {
	...
	public ModelAndView getBRS36_View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
				...
				List<BRS36_ENTITY> T1rep = new ArrayList<BRS36_ENTITY>();
			

				List<BRS36_ENTITY> T1Master = new ArrayList<BRS36_ENTITY>();
				...
				try {
					...
					T1Master = hs.createQuery("from BRS36_ENTITY a where a.report_date = ?1 ", BRS36_ENTITY.class)
	...
	public ModelAndView getBRS36Details(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"BRS36::reportcontent");
	...
	public File getFileBRS36(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS36.jrxml");
					}
