...
import com.bornfire.xbrl.entities.BRSS.BRS41_ENTITY;
...
public class BRS41_SERVICE {
	
	private static final Logger logger = LoggerFactory.getLogger(BRS41_SERVICE.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS41_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS41_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS41_View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BRS41_ENTITY> T1rep = new ArrayList<BRS41_ENTITY>();
			// Query<Object[]> qr;

			List<BRS41_ENTITY> T1Master = new ArrayList<BRS41_ENTITY>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BRS41_ENTITY a where a.report_date = ?1 ", BRS41_ENTITY.class)
	...
	public ModelAndView getBRS41Details(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"BRS41::reportcontent");
	...
	public File getFileBRS41(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS41.jrxml");
					}
