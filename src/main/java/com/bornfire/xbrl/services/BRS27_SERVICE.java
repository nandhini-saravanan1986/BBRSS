...
import com.bornfire.xbrl.entities.BRSS.BRS27_ENTITY;
...
public class BRS27_SERVICE {
	
	private static final Logger logger = LoggerFactory.getLogger(BRS27_SERVICE.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS27_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS27_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS27_view(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BRS27_ENTITY> T1rep = new ArrayList<BRS27_ENTITY>();
			// Query<Object[]> qr;

			List<BRS27_ENTITY> T1Master = new ArrayList<BRS27_ENTITY>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BRS27_ENTITY a where a.report_date = ?1 ", BRS27_ENTITY.class)
	...
	public ModelAndView getBRS27currentDtl(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"brs27::reportcontent");
	...
	public File getFileBRS27(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS27.jrxml");
					} else {
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS27.jrxml");
					}
