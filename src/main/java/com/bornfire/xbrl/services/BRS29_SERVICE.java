...
import com.bornfire.xbrl.entities.BRSS.BRS29_ENTITY;
...
public class BRS29_SERVICE {
	
	private static final Logger logger = LoggerFactory.getLogger(BRS29_SERVICE.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS29_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS29_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS29_view(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BRS29_ENTITY> T1rep = new ArrayList<BRS29_ENTITY>();
			// Query<Object[]> qr;

			List<BRS29_ENTITY> T1Master = new ArrayList<BRS29_ENTITY>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BRS29_ENTITY a where a.report_date = ?1 ", BRS29_ENTITY.class)
	...
	public ModelAndView getBRS29currentDtl(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"brs29::reportcontent");
	...
	public File getFileBRS29(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS29.jrxml");
					} else {
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS29.jrxml");
					}
