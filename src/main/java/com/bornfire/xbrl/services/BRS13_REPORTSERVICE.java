...
import com.bornfire.xbrl.entities.BRSS.BRS13_ENTITY;
...
public class BRS13_REPORTSERVICE {
	private static final Logger logger = LoggerFactory.getLogger(BRS13_REPORTSERVICE.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS13_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS13_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS13View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BRS13_ENTITY> T1rep = new ArrayList<BRS13_ENTITY>();
			// Query<Object[]> qr;

			List<BRS13_ENTITY> T1Master = new ArrayList<BRS13_ENTITY>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BRS13_ENTITY a where a.report_date = ?1 ", BRS13_ENTITY .class)
	...
	public ModelAndView getBRS13currentDtl(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"BRS13::reportcontent");
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS13.jrxml");
					}
