...
import com.bornfire.xbrl.entities.BRSS.BRS14_ENTITY;
...
public class BRS14_REPORTSERVICE {
	private static final Logger logger = LoggerFactory.getLogger(BRS14_REPORTSERVICE.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS14_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS14_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS14View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BRS14_ENTITY> T1rep = new ArrayList<BRS14_ENTITY>();
			// Query<Object[]> qr;

			List<BRS14_ENTITY> T1Master = new ArrayList<BRS14_ENTITY>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BRS14_ENTITY a where a.report_date = ?1 ", BRS14_ENTITY .class)
	...
	public ModelAndView getBRS14currentDtl(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"BRS14::reportcontent");
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS14.jrxml");
					}
