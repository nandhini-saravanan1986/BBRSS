...
import com.bornfire.xbrl.entities.BRSS.BRS38_ENTITY;
...
public class BRS38_SERVICE {
	
	private static final Logger logger = LoggerFactory.getLogger(BRS38_SERVICE.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS38_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS38_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS38_View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BRS38_ENTITY> T1rep = new ArrayList<BRS38_ENTITY>();
			// Query<Object[]> qr;

			List<BRS38_ENTITY> T1Master = new ArrayList<BRS38_ENTITY>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BRS38_ENTITY a where a.report_date = ?1 ", BRS38_ENTITY.class)
	...
	public ModelAndView getBRS38Details(String reportId, String fromdate, String todate, String currency,
	...
	public File getFileBRS38(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS38.jrxml");
					}
