...
import com.bornfire.xbrl.entities.BRSS.BRS31_ENTITY;
import com.bornfire.xbrl.entities.BRSS.BRS62_ENTITY;
import com.bornfire.xbrl.entities.BRSS.BRS63_ENTITY;
import com.bornfire.xbrl.entities.BRSS.BRS64_ENTITY;
import com.bornfire.xbrl.entities.BRSS.BRS65_ENTITY;
...
public class BRS62_SERVICE {
	
	private static final Logger logger = LoggerFactory.getLogger(BRS62_SERVICE.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS62_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS62_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS62_view(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BRS62_ENTITY> T1rep = new ArrayList<BRS62_ENTITY>();
			// Query<Object[]> qr;

			List<BRS62_ENTITY> T1Master = new ArrayList<BRS62_ENTITY>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BRS62_ENTITY a where a.report_date = ?1 ", BRS62_ENTITY.class)
	...
	public ModelAndView getBRS62currentDtl(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"brs62::reportcontent");
	...
	public File getFileBRS62(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS62.jrxml");
					} else {
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS62.jrxml");
					}
