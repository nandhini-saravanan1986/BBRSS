...
import com.bornfire.xbrl.entities.BRSS.BRS3_ENTITY;
...
public class BRS3REPORTSERVICE {
	private static final Logger logger = LoggerFactory.getLogger(BRS3REPORTSERVICE.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS3_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS3_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS3View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BRS3_ENTITY> T1rep = new ArrayList<BRS3_ENTITY>();
			// Query<Object[]> qr;

			List<BRS3_ENTITY> T1Master = new ArrayList<BRS3_ENTITY>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BRS3_ENTITY a where a.report_date = ?1 ", BRS3_ENTITY .class)
	...
	public ModelAndView getBRS3currentDtl(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"BRS3::reportcontent");
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BOB_RBS_AML_CONS/RBS_DETAILS/T1Detail.jasper");
					} else {
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRF11AA.jrxml");
					}

				} else {
					if (dtltype.equals("report")) {
						logger.info("Inside report");
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRF11A.jrxml");
					} else {
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRF11A.jrxml");
					}
				}
