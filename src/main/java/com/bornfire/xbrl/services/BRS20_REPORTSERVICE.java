...
import com.bornfire.xbrl.entities.BRSS.BRS20_ENTITY;
...
public class BRS20_REPORTSERVICE {
	private static final Logger logger = LoggerFactory.getLogger(BRS20_REPORTSERVICE.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS20_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS20_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS20View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BRS20_ENTITY> T1rep = new ArrayList<BRS20_ENTITY>();
			// Query<Object[]> qr;

			List<BRS20_ENTITY> T1Master = new ArrayList<BRS20_ENTITY>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BRS20_ENTITY a where a.report_date = ?1 ", BRS20_ENTITY .class)
	...
	public ModelAndView getBRS20currentDtl(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"BRS20::reportcontent");
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BAMS_BRF4.jrxml");
					}
