...
import com.bornfire.xbrl.entities.BRSS.BRS26_ENTITY;
...
public class BRS26_SERVICE {
	
	private static final Logger logger = LoggerFactory.getLogger(BRS26_SERVICE.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS26_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS26_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS26_view(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BRS26_ENTITY> T1rep = new ArrayList<BRS26_ENTITY>();
			// Query<Object[]> qr;

			List<BRS26_ENTITY> T1Master = new ArrayList<BRS26_ENTITY>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BRS26_ENTITY a where a.report_date = ?1 ", BRS26_ENTITY.class)
	...
	public ModelAndView getBRS26currentDtl(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"brs26::reportcontent");
	...
	public File getFileBRS26(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS26.jrxml");
					} else {
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS26.jrxml");
					}
