...
import com.bornfire.xbrl.entities.BRSS.BRS68_ENTITY;
...
public class BRS68_SERVICE {
	private static final Logger logger = LoggerFactory.getLogger(BRS68_SERVICE.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
		...
		try {
			...
			Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS68_ENTITY a where a.report_date=?1")
					.setParameter(1, dt9).getSingleResult();

			if (dtlcnt > 0) {
				logger.info("Getting No of records in Mod table :" + reportid);
				Long modcnt = (Long) hs.createQuery("select count(*) from BRS68_ENTITY a").getSingleResult();
				if (modcnt > 0) {
					msg = "success";
				}
			} else {
	...
	public ModelAndView getBRS68_View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
				...
				List<BRS68_ENTITY> T1rep = new ArrayList<BRS68_ENTITY>();
			

				List<BRS68_ENTITY> T1Master = new ArrayList<BRS68_ENTITY>();
				...
				try {
					...
					T1Master = hs.createQuery("from BRS68_ENTITY a where a.report_date = ?1 ", BRS68_ENTITY.class)
	...
	public ModelAndView getBRS68Details(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"BRS68::reportcontent");
	...
	public File getFileBRS68(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS68.jrxml");
					}
