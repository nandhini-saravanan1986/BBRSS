...
import com.bornfire.xbrl.entities.BRSS.BRS40_ENTITY;
...
public class BRS40_SERVICE {
	
	private static final Logger logger = LoggerFactory.getLogger(BRS40_SERVICE.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS40_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS40_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS40_View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BRS40_ENTITY> T1rep = new ArrayList<BRS40_ENTITY>();
			// Query<Object[]> qr;

			List<BRS40_ENTITY> T1Master = new ArrayList<BRS40_ENTITY>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BRS40_ENTITY a where a.report_date = ?1 ", BRS40_ENTITY.class)
	...
	public ModelAndView getBRS40Details(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"BRS40::reportcontent");
	...
	public File getFileBRS40(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS40.jrxml");
					}
