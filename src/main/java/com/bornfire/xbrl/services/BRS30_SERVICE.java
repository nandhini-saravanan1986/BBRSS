...
import com.bornfire.xbrl.entities.BRSS.BRS30_ENTITY;
...
public class BRS30_SERVICE {
	
	private static final Logger logger = LoggerFactory.getLogger(BRS30_SERVICE.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS30_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS30_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS30_view(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BRS30_ENTITY> T1rep = new ArrayList<BRS30_ENTITY>();
			// Query<Object[]> qr;

			List<BRS30_ENTITY> T1Master = new ArrayList<BRS30_ENTITY>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BRS30_ENTITY a where a.report_date = ?1 ", BRS30_ENTITY.class)
	...
	public ModelAndView getBRS30currentDtl(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"brs30::reportcontent");
	...
	public File getFileBRS30(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS30.jrxml");
					} else {
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS30.jrxml");
					}
