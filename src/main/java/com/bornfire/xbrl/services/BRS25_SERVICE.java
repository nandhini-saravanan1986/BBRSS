...
public class BRS25_SERVICE {
	
	private static final Logger logger = LoggerFactory.getLogger(BRS25_SERVICE.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS25_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS25_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS25_view(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BRS25_ENTITY> T1rep = new ArrayList<BRS25_ENTITY>();
			// Query<Object[]> qr;

			List<BRS25_ENTITY> T1Master = new ArrayList<BRS25_ENTITY>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BRS25_ENTITY a where a.report_date = ?1 ", BRS25_ENTITY.class)
	...
	public ModelAndView getBRS25currentDtl(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"brs25::reportcontent");
	...
	public File getFileBRS25(String reportId, String fromdate, String todate, String currency, String dtltype,
