...
import com.bornfire.xbrl.entities.BRSS.BRS32_ENTITY;
...
public class BRS32_SERVICE {
	private static final Logger logger = LoggerFactory.getLogger(BRS32_SERVICE.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS32_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS32_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS32_View(String reportId, String fromdate, String todate, String currency, String dtltype,
				...
				List<BRS32_ENTITY> T1rep = new ArrayList<BRS32_ENTITY>();
				
				List<BRS32_ENTITY> T1Master = new ArrayList<BRS32_ENTITY>();
				...
				//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
					...
					T1Master = hs.createQuery("from  BRS32_ENTITY a where a.report_date = ?1 ", BRS32_ENTITY .class)
	...
	public ModelAndView getBRS32Details(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"BRS32::reportcontent");
	...
	public File getFileBRS32(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS32.jrxml");
					} else {
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS32.jrxml");
					}
