...
import com.bornfire.xbrl.entities.BRSS.BRS34_ENTITY;
import com.bornfire.xbrl.entities.BRSS.BRS34_T2_ENTITY;
...
public class BRS34_SERVICE {
	private static final Logger logger = LoggerFactory.getLogger(BRS34_SERVICE.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS34_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRS34_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRS34_View(String reportId, String fromdate, String todate, String currency, String dtltype,
				...
				List<BRS34_ENTITY> T1rep = new ArrayList<BRS34_ENTITY>();
				
				List<BRS34_ENTITY> T1Master = new ArrayList<BRS34_ENTITY>();

				// Query<Object[]> qr;

	 

				List<BRS34_T2_ENTITY> T2Master = new ArrayList<BRS34_T2_ENTITY>();
				...
				//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
					...
					T1Master = hs.createQuery("from  BRS34_ENTITY a where a.report_date = ?1 ", BRS34_ENTITY .class)

							.setParameter(1, df.parse(todate)).getResultList();
					
					T2Master = hs.createQuery("from  BRS34_T2_ENTITY a where a.report_date = ?1 ", BRS34_T2_ENTITY .class)
	...
	public ModelAndView getBRS34Details(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"BRS34::reportcontent");
	...
	public File getFileBRS34(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS34.jrxml");
					} else {
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRS34.jrxml");
					}
