...
@Entity
@Table(name="BRS65_TABLE")

public class BRS65_ENTITY {
	...
	public BRS65_ENTITY(String r15_product, BigDecimal r15_resident, BigDecimal r15_non_resident, String r16_product,
